...
- 🔭 I’m currently working on ...
    ...
    - [hasher-apis](https://github.com/ganeshkbhat/apis-hasher) [npm](https://www.npmjs.com/package/hasher-apis) [prod] create hashes or encrypt (one-wy, two-way) of data, files, and/ or create keys using the crypto module of nodejs
