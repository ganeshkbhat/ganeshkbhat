...
- 🔭 I’m currently working on ...
    ...
    - [kvSQL](https://github.com/ganeshkbhat/keyvalue-db) | [npm](https://www.npmjs.com/package/kvsql) fast, secure, private, and memory leak resistant in-memory key-value js-sqlite based datastore or database that supports tcp mtls (tls), and a command shell (without or with [todo] authentication)
